    ...
    <>
      ...
      <div className="max-w-7xl mx-auto w-full px-6 mt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          {/* Edit / Save / Cancel — only for editable tabs */}
          ...
          <div className="w-full max-w-xs rounded-xl bg-background p-5 shadow-xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <span className="relative flex justify-center text-xs uppercase"><span className="bg-background px-2 text-muted-foreground">or</span></span>
              </div>
