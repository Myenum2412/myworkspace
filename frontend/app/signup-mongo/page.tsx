...
import { SignupFormMongo } from "@/components/signup-form-mongo";

export default async function SignupMongoPage(props: { searchParams: Promise<Record<string, string>> }) {
  return (
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10 bg-background">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-sm">
            <SignupFormMongo error={(await props.searchParams).error} />
          </div>
        </div>
