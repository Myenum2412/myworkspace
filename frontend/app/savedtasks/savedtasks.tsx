...
export default function SavedTasksClient() {
  ...
  useEffect(() => {
    ...
    fetch("/api/user/profile", { credentials: "include" })
      ...
      .then((d) => {
        ...
        if (orgId) {
          return fetch(`/api/tasks?orgId=${orgId}&saved=true`, { credentials: "include" });
        }
        return null;
      })
      .then((res) => res?.json())
      ...
      <main className="flex flex-1 flex-col gap-4 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {!loading && <Badge variant="secondary">{tasks.length} tasks</Badge>}
