...
export async function GET() {
  ...
  try {
    ...
    const revisions = (raw as any[]).map((t, index) => ({
      ...
      project: t.project || "",
      rfiNumber: t.rfiNumber || "",
      jobNumber: t.jobNumber || "",
      jobName: t.jobName || "",
      elements: t.elements || "",
      responseDate: t.responseDate || t.dueDate || null,
      impactTask: Boolean(t.impactTask),
      impactedTaskId: t.impactedTaskId || "",
      impactedTaskName: t.impactedTaskName || "",
      description: t.title || "",
      numberSheets: Number(t.numberSheets ?? 0),
