...
export function EditClientFormFields(props: {
  ...
  return (
    <div className="space-y-8 py-2 [&_input]:border-black [&_input]:bg-white [&_select>button]:border-black [&_select>button]:bg-white [&_textarea]:border-black [&_textarea]:bg-white">
      <FieldSet>
      ...
      <FieldSet>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Field>
            ...
            />
            {fe("primaryContact") && (
              <p className="text-xs text-destructive mt-1">{fe("primaryContact")}</p>
            )}
          </Field>
          <Field>
      ...
      <FieldSet>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Field>
            ...
            <Input placeholder="" value={v.taxId} onChange={(e) => set("taxId", e.target.value)} />
          </Field>
        </div>
      </FieldSet>
      ...
      <FieldSet>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Field>
            ...
            <Input placeholder="" value={v.upiId} onChange={(e) => set("upiId", e.target.value)} />
          </Field>
        </div>
      </FieldSet>
