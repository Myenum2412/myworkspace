...
import { CheckCircleIcon, FileIcon, ListTodoIcon, Loader2Icon } from "@/lib/icons";
import { type ApprovalItem, approvedColumns } from "../columns";
          ...
          {selectedItem && (
            <>
              <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-2 shrink-0">
                ...
                <DialogDescription>
                  Approved {isFile ? "file upload" : "task"} details.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-3 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="rounded-sm border bg-card px-3 py-2">
                    ...
                    <p className="font-medium text-green-400 mt-0.5">Approved</p>
                  </div>
                  <div className="rounded-sm border bg-card px-3 py-2">
                  ...
                  <div className="rounded-sm border bg-card px-3 py-2">
                    ...
                    <p className="font-medium mt-0.5">
                      {selectedItem.approvedAt
                        ? new Date(selectedItem.approvedAt).toLocaleDateString()
                        : "—"}
                    </p>
                  </div>
                </div>
