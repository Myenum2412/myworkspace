...
export default function Approved({ initialTasks }: ApprovedProps) {
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-6 py-3 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="rounded-lg border bg-card px-3 py-2"><p className="text-[11px] text-muted-foreground">Status</p><p className="font-medium text-green-400 mt-0.5">Approved</p></div>
                  ...
                  <div className="rounded-lg border bg-card px-3 py-2"><p className="text-[11px] text-muted-foreground">Approved By</p><p className="font-medium mt-0.5">{selectedTask.approvedBy || "—"}</p></div>
                  <div className="rounded-lg border bg-card px-3 py-2"><p className="text-[11px] text-muted-foreground">Approved At</p><p className="font-medium mt-0.5">{selectedTask.approvedAt ? new Date(selectedTask.approvedAt).toLocaleDateString() : "—"}</p></div>
                </div>
