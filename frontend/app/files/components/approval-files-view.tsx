  ...
  switch (status) {
    ...
    default:
      return (
        <Badge
          variant="outline"
          className="bg-gray-50 text-gray-600 border-gray-200 dark:bg-gray-950/30 dark:text-gray-400 dark:border-gray-800"
        >
          None
        </Badge>
      );
...
export function ApprovalFilesView() {
  ...
  const pendingFiles = useMemo(() => files.filter((f) => f.approvalStatus === "pending"), [files]);
