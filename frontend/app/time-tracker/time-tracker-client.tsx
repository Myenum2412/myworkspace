          ...
          <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
            <div className="rounded-sm border bg-card text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                ...
                <div
                  className={`flex items-center gap-1 text-xs mt-1 ${changeDir === "up" ? "text-green-600" : "text-rose-600"}`}
                >
            ...
            <div className="rounded-sm border bg-card text-card-foreground shadow-sm">
              ...
              <div className="p-6 pt-0">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {data.utilization}% utilization rate
                </p>
              </div>
            </div>
            <div className="rounded-sm border bg-card text-card-foreground shadow-sm">
                    ...
                    data.topMembers.map((m) => (
                      <div key={m.rank} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground">
                            {m.billable.toFixed(1)}h billable
                          </span>
                        </div>
                      </div>
                    ))
