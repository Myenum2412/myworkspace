...
export const PUBLIC_ROUTES = ["/login", "/signup", "/signup-mongo", "/forgot-password", "/auth/not-found", "/", "/features", "/solutions", "/platform", "/about", "/blog", "/contact", "/careers", "/changelog", "/docs", "/guides", "/new-update"];
export const WORKSPACE_ROUTES = [
  ...
  "/upcomingtasks", "/terminated",
  "/upload", "/billing", "/files",
  "/attendance", "/appointments", "/engagement", "/stocks", "/reworks"
];
