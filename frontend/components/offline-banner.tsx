...
export function OfflineBanner() {
  ...
  const variants: Record<BannerState["kind"], string> = {
    online: "bg-red-900 text-red-700 border border-gray-300",
    offline: "bg-gray-700 text-gray-700 border border-gray-300",
    syncing: "bg-gray-700 text-gray-700 border border-gray-300",
