...
export function LoginForm({ className, error, ...props }: React.ComponentProps<"div"> & { error?: string }) {
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Button variant="outline" type="button" className="w-full flex items-center justify-center text-sm font-medium gap-2" aria-label="Sign in with Google" onClick={() => signIn("google", { callbackUrl: "/dashboard" })} disabled={loading}>
