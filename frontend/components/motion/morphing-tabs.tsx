...
function liquidTabPath(tabLeft: number, surfaceWidth: number) {
  ...
  const left = Math.max(panelLeft, Math.min(panelRight - TAB_WIDTH, tabLeft));
...
function LiquidSurfacePath({
  ...
  const path = useTransform(left, (value) => liquidTabPath(value, surfaceWidth));
                ...
                >
                  {!isActive ? (
                    <span
                      ...
                      className={cn(
                        ...
                        isDragging ? "bg-[#3a3a3a]" : "bg-transparent group-hover:bg-white/[0.06]",
                      )}
                    />
                  ) : null}
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isActive ? "text-[#181818]" : "pb-2 text-white/70 hover:text-white",
                      classNames?.tab,
                    )}
                  >
                    <span
