  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          ...
          {showTail && isOutgoing && (
            <svg
              ...
              role="img"
              aria-label="Outgoing message tail"
            >
              <title>Outgoing message tail</title>
              <path
                opacity="0.13"
          ...
          {showTail && !isOutgoing && (
            <svg
              ...
              role="img"
              aria-label="Incoming message tail"
            >
              <title>Incoming message tail</title>
              <path
                opacity="0.13"
          ...
          {/* Message content */}
          <div className="text-[14.2px] leading-[19px] text-wa-text-primary">{children}</div>
        ...
        {hasReactions && (
          <div
            className={cn("absolute flex gap-[3px]", isOutgoing ? "right-[8px]" : "left-[8px]")}
