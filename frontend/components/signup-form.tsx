...
export function SignupForm({
  ...
  plan,
  ...props
}: React.ComponentProps<"div"> & { error?: string; plan?: string }) {
    ...
    return (
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <Button
          variant="outline"
          type="button"
          className="w-full flex items-center justify-center text-sm font-medium gap-2"
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col gap-2 text-center">
        ...
        {plan && (
          <p className="text-xs font-medium text-brand-600 capitalize">Selected plan: {plan}</p>
        )}
      </div>
