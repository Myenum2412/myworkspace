...
export default function CookieConsentBlock() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background">
      <div className="pointer-events-none mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="pointer-events-auto flex shrink-0 items-center gap-2">
          ...
          <Button onClick={() => handleConsent("accepted")} className="flex-1 md:flex-none">
            Accept all
          </Button>
        </div>
      </div>
