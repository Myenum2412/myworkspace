    ...
    >
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  isActive
                    ? "border-blue-500 bg-white text-neutral-900 shadow-[0_20px_60px_-12px_rgba(37,150,190,0.3)]"
                    : "border-neutral-200/80 bg-white/80 text-neutral-800 shadow-[0_8px_24px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_32px_-4px_rgba(0,0,0,0.1)]",
                )}
      ...
      <div className="flex items-center gap-4">
        <motion.button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 bg-white text-neutral-600 shadow-sm transition-colors hover:bg-neutral-50 hover:text-neutral-900 focus-visible:ring-2 focus-visible:ring-neutral-200"
        >
