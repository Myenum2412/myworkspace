...
import { Sparkles, BookOpen, Rocket, ArrowRight, PlayCircle } from '@/lib/icons'
                    ...
                    <CardHeader className='px-6'>
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                          ...
                          <CardTitle className='text-base text-balance text-neutral-900'>Documentation</CardTitle>
                        </div>
                    ...
                    <CardHeader className='px-6'>
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                          ...
                          <CardTitle className='text-base text-balance text-neutral-900'>Video Tutorials</CardTitle>
                        </div>
                        <ArrowRight className='text-muted-foreground size-4 transition-transform group-hover:translate-x-1' />
                      </div>
                    </CardHeader>
