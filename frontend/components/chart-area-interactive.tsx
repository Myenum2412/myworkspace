    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>Active employees and new hires over the last 3 months</CardDescription>
        </div>
        <Select value={timeRange} onValueChange={setTimeRange}>
          <SelectTrigger
            className="hidden w-[160px] rounded-sm sm:ml-auto sm:flex"
            aria-label="Select a value"
          >
            <SelectValue placeholder="" />
          </SelectTrigger>
          <SelectContent className="rounded-sm">
            <SelectItem value="90d" className="rounded-sm">
              Last 3 months
            </SelectItem>
            <SelectItem value="30d" className="rounded-sm">
              Last 30 days
            </SelectItem>
            <SelectItem value="7d" className="rounded-sm">
              Last 7 days
            </SelectItem>
          </SelectContent>
        </Select>
