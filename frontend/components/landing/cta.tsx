        ...
        <div className="relative overflow-hidden rounded-sm bg-gradient-to-br from-brand-800 to-brand-900 px-6 py-16 sm:px-12 sm:py-20">
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Button size="lg" asChild className="px-8 text-base font-medium bg-white text-brand-900 hover:bg-brand-100 shadow-lg transition-all duration-200 touch-target">
                <Link href="/signup">
                  Get Started Free
                  <ArrowRight className="ml-2 size-4" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" asChild className="px-8 text-base font-medium border-brand-400 text-white hover:bg-white/10 touch-target">
