        ...
        <div className="relative overflow-hidden rounded-sm bg-gradient-to-br from-brand-800 to-brand-900 px-6 py-16 sm:px-12 sm:py-20">
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-responsive text-brand-300">
              Join thousands of teams already shipping faster with MyWorkSpace. Start your free
              trial today.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Button
                size="lg"
                asChild
                className="px-8 text-base font-medium bg-white text-brand-900 hover:bg-brand-100 shadow-lg transition-all duration-200 touch-target"
              >
                <Link href="/signup">
                  Get Started Free
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="px-8 text-base font-medium border-brand-400 text-white hover:bg-white/10 touch-target"
              >
