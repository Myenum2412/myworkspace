...
export declare const NOTIFICATION_TYPES: readonly ["task_assigned", "task_updated", "mention", "invite", "system", "comment", "status_change", "message", "project_update", "billing_reminder", "approval_request", "team_update", "announcement"];
