...
export const notifyClient = {
  ...
  async assigned(
    ...
    return createNotification({
      ...
      link: `/clients?id=${clientId}`,
      actions: [
        { label: "View Client", action: "view", url: `/clients?id=${clientId}`, primary: true },
      ],
      metadata: { clientId, clientName },
    });
  },
  ...
  async approvedDeliverables(
    ...
    return createNotification({
      ...
      orgId,
      createdBy: userId,
      type: "client_approved_deliverables",
      category: "clients",
  ...
  async rejectedDeliverables(
    ...
    return createNotification({
      ...
      orgId,
      createdBy: userId,
      type: "client_rejected_deliverables",
      category: "clients",
      priority: "high",
  ...
  async contractSigned(
    ...
    return createNotification({
      ...
      link: `/clients?id=${clientId}`,
      actions: [
        { label: "View Contract", action: "view", url: `/clients?id=${clientId}`, primary: true },
      ],
