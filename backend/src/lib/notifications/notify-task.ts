...
export const notifyTask = {
  ...
  async dependenciesCompleted(userId: string, orgId: string, taskTitle: string, taskId: string) {
    return createNotification({
      ...
      orgId,
      createdBy: userId,
      type: "task_dependencies_completed",
      category: "tasks",
  ...
  async commentAdded(
    ...
    return createNotification({
      ...
      link: `/alltasks?id=${taskId}`,
      actions: [
        { label: "View Comment", action: "view", url: `/alltasks?id=${taskId}`, primary: true },
      ],
      metadata: { taskId, commentAuthor },
    });
  },

  async attachmentAdded(
    userId: string,
    orgId: string,
    addedBy: string,
    taskTitle: string,
  ...
  async estimatedHoursUpdated(
    ...
    return createNotification({
      ...
      orgId,
      createdBy: userId,
      type: "task_estimated_hours_updated",
      category: "tasks",
  ...
  async actualHoursSubmitted(
    ...
    return createNotification({
      ...
      orgId,
      createdBy: userId,
      type: "task_actual_hours_submitted",
      category: "tasks",
      title: "Hours Logged",
