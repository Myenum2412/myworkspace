...
export class BillingEngine {
  async seedPlans(): Promise<void> {
    const plans = [
      { key: "free", name: "Free", description: "For individuals", sortOrder: 0, features: ["1 project", "1 GB storage", "5 tasks"], prices: { monthly: 0, yearly: 0 }, limits: { projects: 1, storageMB: 1024, tasks: 5, members: 1 }, addonsAvailable: [] },
