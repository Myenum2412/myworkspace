...
export async function sendWelcomeEmail(to: string, name: string): Promise<void> {
  const data = Factory.buildWelcomeEmail(
    name,
    to,
    "MyWorkspace",
    null,
...
export async function sendAccountOnboardingReminder(
  to: string,
  firstName: string,
  email: string,
  workspaceName: string,
  ...
  const data = Factory.buildAccountOnboardingReminder(
    firstName,
    email,
    workspaceName,
    role,
...
export async function sendGettingStarted(
  to: string,
  firstName: string,
  docsUrl: string,
): Promise<void> {
...
export async function sendWorkspaceSetupComplete(
  to: string,
  workspaceName: string,
  loginUrl: string,
): Promise<void> {
...
export async function sendNewDeviceLogin(
  to: string,
  firstName: string,
  deviceName: string,
  location: string,
...
export async function sendPasswordDeliveredEmail(
  to: string,
  name: string,
  email: string,
  password: string,
...
export async function sendTaskCreated(
  ...
  const data = Factory.buildTaskCreated(
    firstName,
    taskTitle,
    projectName,
    createdBy,
...
export async function sendTaskAssigned(
  ...
  const data = Factory.buildTaskAssigned(
    firstName,
    taskTitle,
    projectName,
    assignedBy,
...
export async function sendTaskUpdated(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
  ...
  const data = Factory.buildTaskUpdated(
    firstName,
    taskTitle,
    projectName,
    updatedBy,
...
export async function sendTaskDueSoon(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
  ...
  const data = Factory.buildTaskDueSoon(
    firstName,
    taskTitle,
    projectName,
    dueDate,
...
export async function sendTaskOverdue(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
  ...
  const data = Factory.buildTaskOverdue(
    firstName,
    taskTitle,
    projectName,
    dueDate,
...
export async function sendTaskReopened(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
  ...
  const data = Factory.buildTaskReopened(
    firstName,
    taskTitle,
    projectName,
    reopenedBy,
...
export async function sendTaskCommentAdded(
  ...
  const data = Factory.buildTaskCommentAdded(
    firstName,
    taskTitle,
    projectName,
    commentAuthor,
...
export async function sendTaskStatusChanged(
  ...
  const data = Factory.buildTaskStatusChanged(
    firstName,
    taskTitle,
    projectName,
    changedBy,
...
export async function sendTaskPriorityChanged(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
  ...
  const data = Factory.buildTaskPriorityChanged(
    firstName,
    taskTitle,
    projectName,
    changedBy,
...
export async function sendTaskDeleted(
  to: string,
  firstName: string,
  taskTitle: string,
  projectName: string,
...
export async function sendDailyTaskSummary(
  ...
  const data = Factory.buildDailyTaskSummary(
    firstName,
    projectName,
    completedCount,
    pendingCount,
...
function createSimpleEmailData(opts: {
  ...
  previewText: string;
  firstName: string;
  statusType: StatusIndicator["type"];
  statusLabel: string;
  intro: string[];
...
export async function sendTeamTaskSubmitted(
  to: string,
  firstName: string,
  taskTitle: string,
  submittedBy: string,
...
export async function sendTeamTaskApproved(
  to: string,
  firstName: string,
  taskTitle: string,
  approvedBy: string,
...
export async function sendTeamTaskRejected(
  to: string,
  firstName: string,
  taskTitle: string,
  rejectedBy: string,
...
export async function sendEmployeeInvited(
  to: string,
  firstName: string,
  inviterName: string,
  workspaceName: string,
...
export async function sendEmployeeOnboarded(
  ...
  const data = Factory.buildEmployeeOnboarded(
    firstName,
    email,
    workspaceName,
    loginUrl,
...
export async function sendOnboardingReminder(
  ...
  const data = Factory.buildOnboardingReminder(
    firstName,
    email,
    workspaceName,
    daysSinceCreation,
...
export async function sendRoleChanged(
  ...
  const data = Factory.buildRoleChanged(
    firstName,
    changedBy,
    oldRole,
    newRole,
...
export async function sendLeaveRequestSubmitted(
  ...
  const data = Factory.buildLeaveRequestSubmitted(
    firstName,
    leaveType,
    startDate,
    endDate,
...
export async function sendLeaveRequestApproved(
  ...
  const data = Factory.buildLeaveRequestApproved(
    firstName,
    leaveType,
    startDate,
    endDate,
...
export async function sendLeaveRequestRejected(
  ...
  const data = Factory.buildLeaveRequestRejected(
    firstName,
    leaveType,
    startDate,
    endDate,
...
export async function sendEmployeeDeactivated(
  to: string,
  firstName: string,
  ...
  const data = Factory.buildEmployeeDeactivated(
    firstName,
    deactivatedBy,
    reason,
    supportEmail || "support@workspace.com",
...
export async function sendEmployeeReactivated(
  to: string,
  firstName: string,
...
export async function sendEmployeeProfileUpdated(
  to: string,
  firstName: string,
  updatedBy: string,
  changes: string,
...
export async function sendWorkAnniversary(
  to: string,
  firstName: string,
  years: number,
  workspaceName: string,
...
export async function sendLeaveRequestActionNeeded(
  to: string,
  firstName: string,
  employeeName: string,
  leaveType: string,
  ...
  const data = Factory.buildLeaveRequestActionNeeded(
    firstName,
    employeeName,
    leaveType,
    startDate,
...
export async function sendProjectCreated(
  to: string,
  firstName: string,
  projectName: string,
  createdBy: string,
  ...
  const data = Factory.buildProjectCreated(
    firstName,
    projectName,
    createdBy,
    startDate,
...
export async function sendProjectUpdated(
  to: string,
  firstName: string,
  projectName: string,
  updatedBy: string,
...
export async function sendProjectMilestoneReached(
  to: string,
  firstName: string,
  projectName: string,
  ...
  const data = Factory.buildProjectMilestoneReached(
    firstName,
    projectName,
    milestoneName,
    achievedBy,
...
export async function sendProjectDeadlineExtended(
  to: string,
  firstName: string,
  projectName: string,
  extendedBy: string,
  ...
  const data = Factory.buildProjectDeadlineExtended(
    firstName,
    projectName,
    extendedBy,
    oldDeadline,
...
export async function sendProjectCompleted(
  ...
  const data = Factory.buildProjectCompleted(
    firstName,
    projectName,
    completedBy,
    totalTasks,
...
export async function sendProjectMemberAdded(
  to: string,
  firstName: string,
  projectName: string,
  addedBy: string,
  ...
  const data = Factory.buildProjectMemberAdded(
    firstName,
    projectName,
    addedBy,
    memberName,
...
export async function sendProjectMemberRemoved(
  to: string,
  firstName: string,
  projectName: string,
  removedBy: string,
  ...
  const data = Factory.buildProjectMemberRemoved(
    firstName,
    projectName,
    removedBy,
    memberName,
...
export async function sendProjectStatusChanged(
  to: string,
  firstName: string,
  projectName: string,
  changedBy: string,
  ...
  const data = Factory.buildProjectStatusChanged(
    firstName,
    projectName,
    changedBy,
    oldStatus,
...
export async function sendProjectWeeklySummary(
  to: string,
  firstName: string,
  projectName: string,
  ...
  const data = Factory.buildProjectWeeklySummary(
    firstName,
    projectName,
    tasksCompleted,
    tasksAdded,
...
export async function sendApprovalRequested(
  ...
  const data = Factory.buildApprovalRequested(
    firstName,
    itemName,
    itemType,
    requestedBy,
...
export async function sendApprovalApproved(
  to: string,
  firstName: string,
  itemName: string,
  itemType: string,
  ...
  const data = Factory.buildApprovalApproved(
    firstName,
    itemName,
    itemType,
    approvedBy,
...
export async function sendApprovalRejected(
  to: string,
  firstName: string,
  itemName: string,
  itemType: string,
  ...
  const data = Factory.buildApprovalRejected(
    firstName,
    itemName,
    itemType,
    rejectedBy,
...
export async function sendApprovalReminder(
  ...
  const data = Factory.buildApprovalReminder(
    firstName,
    itemName,
    itemType,
    requestedBy,
...
export async function sendDocumentApprovalRequested(
  to: string,
  firstName: string,
  documentName: string,
  requestedBy: string,
  ...
  const data = Factory.buildDocumentApprovalRequested(
    firstName,
    documentName,
    requestedBy,
    projectName,
...
export async function sendDocumentApproved(
  to: string,
  firstName: string,
  documentName: string,
  approvedBy: string,
  ...
  const data = Factory.buildDocumentApproved(
    firstName,
    documentName,
    approvedBy,
    projectName,
...
export async function sendDocumentRejected(
  ...
  const data = Factory.buildDocumentRejected(
    firstName,
    documentName,
    rejectedBy,
    projectName,
...
export async function sendFileReviewRequested(
  to: string,
  firstName: string,
  fileName: string,
  requestedBy: string,
  ...
  const data = Factory.buildFileReviewRequested(
    firstName,
    fileName,
    requestedBy,
    projectName,
...
export async function sendFileReviewCompleted(
  to: string,
  firstName: string,
  fileName: string,
  reviewedBy: string,
  ...
  const data = Factory.buildFileReviewCompleted(
    firstName,
    fileName,
    reviewedBy,
    projectName,
...
export async function sendFileUploaded(
  to: string,
  firstName: string,
  fileName: string,
  uploadedBy: string,
  ...
  const data = Factory.buildFileUploaded(
    firstName,
    fileName,
    uploadedBy,
    projectName,
...
export async function sendFileDownloaded(
  to: string,
  firstName: string,
  fileName: string,
  downloadedBy: string,
  ...
  const data = Factory.buildFileDownloaded(
    firstName,
    fileName,
    downloadedBy,
    projectName,
...
export async function sendFileShared(
  ...
  const data = Factory.buildFileShared(
    firstName,
    fileName,
    sharedBy,
    projectName,
...
export async function sendFileVersionUpdated(
  to: string,
  firstName: string,
  fileName: string,
  updatedBy: string,
  ...
  const data = Factory.buildFileVersionUpdated(
    firstName,
    fileName,
    updatedBy,
    projectName,
...
export async function sendFileAccessChanged(
  to: string,
  firstName: string,
  fileName: string,
  changedBy: string,
  ...
  const data = Factory.buildFileAccessChanged(
    firstName,
    fileName,
    changedBy,
    projectName,
...
export async function sendFileDeleted(
  to: string,
  firstName: string,
  fileName: string,
  deletedBy: string,
  ...
  const data = Factory.buildFileDeleted(
    firstName,
    fileName,
    deletedBy,
    projectName,
...
export async function sendFileRenamed(
  to: string,
  firstName: string,
  oldFileName: string,
  newFileName: string,
  ...
  const data = Factory.buildFileRenamed(
    firstName,
    oldFileName,
    newFileName,
    renamedBy,
...
export async function sendFolderShared(
  ...
  const data = Factory.buildFolderShared(
    firstName,
    folderName,
    sharedBy,
    projectName,
...
export async function sendFileRestored(
  to: string,
  firstName: string,
  fileName: string,
  restoredBy: string,
...
export async function sendStorageQuotaWarning(
  to: string,
  firstName: string,
  workspaceName: string,
  usedStorage: string,
  ...
  const data = Factory.buildStorageQuotaWarning(
    firstName,
    workspaceName,
    usedStorage,
    totalStorage,
...
export async function sendDailyDigest(
  ...
  taskUpdates: {
    title: string;
    description?: string;
    status?: import("./templates/types.js").StatusType;
    url?: string;
    meta?: string;
  }[],
  pendingApprovals: {
  ...
  const data = Factory.buildDailyDigest(
    firstName,
    date,
    taskUpdates,
    pendingApprovals,
...
export async function sendWeeklyDigest(
  ...
  const data = Factory.buildWeeklyDigest(
    firstName,
    weekLabel,
    tasksCompleted,
    tasksCreated,
...
export async function sendUnreadNotificationsReminder(
  to: string,
  firstName: string,
  unreadCount: number,
  topNotifications: {
  ...
  const data = Factory.buildUnreadNotificationsReminder(
    firstName,
    unreadCount,
    topNotifications,
    notificationsUrl,
