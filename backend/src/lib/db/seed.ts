...
async function seed() {
  ...
  const tasks = await Task.insertMany([
    ...
    },
    {
      ...
      creatorId: userId,
      assigneeId: userId,
      title: "Unit test coverage for auth module",
      status: "done",
      priority: "medium",
    ...
    },
    {
      ...
      teamId: team._id,
      creatorId: userId,
      title: "WebSocket notification system",
      status: "cancelled",
      priority: "medium",
  ...
  await Notification.insertMany([
    {
      ...
      message: "You've been assigned 'API rate limiting'",
      read: false,
      link: "/tasks",
      createdAt: new Date("2026-06-09"),
    },
    {
      ...
      message: "'Set up CI/CD pipeline' moved to In Progress",
      read: false,
      link: "/tasks",
      createdAt: new Date("2026-06-10"),
    },
    {
      ...
      message: "Demo User mentioned you in 'Design system migration'",
      read: true,
      link: "/tasks",
      createdAt: new Date("2026-06-11"),
    },
    ...
    },
    {
      ...
      message: "'Unit test coverage for auth module' is now Done",
      read: false,
      link: "/tasks",
  ...
  await ActivityLog.insertMany([
    ...
    },
    {
      ...
      entityType: "task",
      entityId: tasks[0]._id.toString(),
      description: "Updated task 'Set up CI/CD pipeline' status to in_progress",
      createdAt: new Date("2026-06-10"),
    },
    {
      orgId,
      ...
      action: "create",
      entityType: "task",
      entityId: tasks[1]._id.toString(),
      description: "Created task 'Design system migration'",
      createdAt: new Date("2026-06-11"),
    },
    {
      orgId,
      ...
      action: "create",
      entityType: "task",
      entityId: tasks[3]._id.toString(),
      description: "Created task 'Unit test coverage for auth module'",
      createdAt: new Date("2026-06-05"),
    },
    {
      orgId,
      ...
      entityType: "task",
      entityId: tasks[3]._id.toString(),
      description: "Completed task 'Unit test coverage for auth module'",
      createdAt: new Date("2026-06-15"),
    },
  ]);
