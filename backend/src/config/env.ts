export const env = {
  ...
  AI_DEFAULT_LANGUAGE: process.env.AI_DEFAULT_LANGUAGE || "en",
  AI_INTENT_THRESHOLD: parseFloat(process.env.AI_INTENT_THRESHOLD || "0.6"),
  AI_MEMORY_MESSAGES: parseInt(process.env.AI_MEMORY_MESSAGES || "20"),
  AI_MEMORY_EXPIRY: parseInt(process.env.AI_MEMORY_EXPIRY || "24"),
  AI_MAX_PRODUCTS: parseInt(process.env.AI_MAX_PRODUCTS || "5"),
  AI_PRODUCT_THRESHOLD: parseFloat(process.env.AI_PRODUCT_THRESHOLD || "0.5"),
  AI_RATE_LIMIT_WINDOW: parseInt(process.env.AI_RATE_LIMIT_WINDOW || "60000"),
  AI_RATE_LIMIT_MAX: parseInt(process.env.AI_RATE_LIMIT_MAX || "30"),
