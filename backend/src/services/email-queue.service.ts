...
async function deliverEmail(emailId: string): Promise<void> {
  ...
  try {
    ...
    const emailData = buildEmailDataForNotification(
      email.template,
      firstName,
      email.subject,
      email.data,
...
function buildEmailDataForNotification(
  template: string,
  firstName: string,
  subject: string,
  dataStr?: string,
  ...
  try {
    ...
    switch (template) {
      case "task_assigned":
      case "task_created":
        return TemplateFactory.buildTaskAssigned(
          firstName,
          data.taskTitle || "Task",
          data.projectName || "",
          data.assignedBy || "Someone",
          data.dueDate || "TBD",
      ...
      case "task_updated":
        return TemplateFactory.buildTaskUpdated(
          firstName,
          data.taskTitle || "Task",
          data.projectName || "",
          data.updatedBy || "Someone",
          data.changes || "No details",
          data.link || "#",
        );
      ...
      case "task_due_today":
      case "task_overdue":
        return TemplateFactory.buildTaskDueSoon(
          firstName,
          data.taskTitle || "Task",
          data.projectName || "",
          data.dueDate || "TBD",
      ...
      case "task_completed":
        return TemplateFactory.buildTaskCompleted(
          firstName,
          data.taskTitle || "Task",
          data.projectName || "",
          data.completedBy || "Someone",
          data.link || "#",
        );

      case "task_comment_added":
        return TemplateFactory.buildTaskCommentAdded(
          firstName,
          data.taskTitle || "Task",
          data.projectName || "",
          data.commentAuthor || "Someone",
          data.commentText || "",
          data.link || "#",
        );

      case "project_created":
        return TemplateFactory.buildProjectCreated(
          firstName,
          data.projectName || "Project",
          data.createdBy || "Someone",
          data.startDate || "TBD",
          data.endDate || "TBD",
          data.link || "#",
        );
      ...
      case "project_completed":
        return TemplateFactory.buildProjectCompleted(
          firstName,
          data.projectName || "Project",
          data.completedBy || "Someone",
          data.totalTasks || 0,
      ...
      case "approval_requested":
        return TemplateFactory.buildApprovalRequested(
          firstName,
          data.itemName || "Item",
          data.itemType || "document",
          data.requestedBy || "Someone",
          data.projectName || "",
          data.reason || "",
          data.link || "#",
        );
      ...
      case "approval_approved":
        return TemplateFactory.buildApprovalApproved(
          firstName,
          data.itemName || "Item",
          data.itemType || "document",
          data.approvedBy || "Someone",
          data.projectName || "",
          data.comments || "",
          data.link || "#",
        );
      ...
      case "approval_rejected":
        return TemplateFactory.buildApprovalRejected(
          firstName,
          data.itemName || "Item",
          data.itemType || "document",
          data.rejectedBy || "Someone",
          data.projectName || "",
          data.reason || "",
          data.feedback || "",
          data.link || "#",
      ...
      case "file_uploaded":
        return TemplateFactory.buildFileUploaded(
          firstName,
          data.fileName || "File",
          data.uploadedBy || "Someone",
          data.projectName || "",
          data.fileSize || "0 B",
      ...
      case "file_shared":
        return TemplateFactory.buildFileShared(
          firstName,
          data.fileName || "File",
      ...
      case "new_device_login":
        return TemplateFactory.buildNewDeviceLogin(
          firstName,
      ...
      case "task_reopened":
        return TemplateFactory.buildTaskReopened(
          firstName,
          data.taskTitle,
          data.projectName,
          data.reopenedBy,
      ...
      case "task_priority_changed":
        return TemplateFactory.buildTaskPriorityChanged(
          firstName,
          data.taskTitle,
          data.projectName,
          data.changedBy,
      ...
      case "project_updated":
        return TemplateFactory.buildProjectUpdated(
          firstName,
          data.projectName,
          data.updatedBy,
          data.changes,
      ...
      case "file_downloaded":
        return TemplateFactory.buildFileDownloaded(
          firstName,
          data.fileName,
          data.downloadedBy,
          data.projectName,
      ...
      case "file_deleted":
        return TemplateFactory.buildFileDeleted(
          firstName,
          data.fileName,
          data.deletedBy,
          data.projectName,
      ...
      case "leave_request_submitted":
        return TemplateFactory.buildLeaveRequestSubmitted(
          firstName,
          data.leaveType,
          data.startDate,
          data.endDate,
      ...
      case "leave_approved":
        return TemplateFactory.buildLeaveRequestApproved(
          firstName,
          data.leaveType,
          data.startDate,
          data.endDate,
      ...
      case "leave_rejected":
        return TemplateFactory.buildLeaveRequestRejected(
          firstName,
          data.leaveType,
          data.startDate,
          data.endDate,
      ...
      case "invoice_generated":
        return {
          ...
          greeting: `Hello ${firstName},`,
          intro: [
            `Invoice ${data.invoiceNumber || ""} for ${data.amount || ""} has been generated.`,
          ],
          details: data.details ? data.details : undefined,
      ...
      case "subscription_nearing_expiration":
        return {
          ...
          metadata: {
            module: "Billing",
            timestamp: new Date().toISOString(),
            action: "subscription_nearing_expiration",
          },
          supportEmail: "support@workspace.com",
        };

      case "client_invitation_sent":
        return TemplateFactory.buildEmployeeInvited(
          firstName,
