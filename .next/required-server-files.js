self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    "env": {
      ...
      "_sentryRelease": "d8cbf2e0e4621536e05ed6ad9c18153168c7899c"
    },
    "typescript": {
    ...
    "outputFileTracingRoot": "/root/myworkspace/frontend",
    ...
    "turbopack": {
      "root": "/root/myworkspace/frontend",
      "debugIds": true,
      "rules": {
  ...
  "appDir": "/root/myworkspace/frontend",
  "relativeAppDir": "",
  "files": [
    ".next/package.json",
